...
class Team {
    constructor() {
        //empty array to hold employee list
        this.employees = [];
        //question array for inquirer prompts
        this.questions = [
            {
                type: "list",
                name: "role",
            ...
            {
                //only when manager role is selected
            ...
            {
                //only when engineer role is selected
            ...
            {
                //only when intern role is selected
...
//makes new classes for each employee based on user input and push to employee array
...
// takes employee array and froms cards for each employee
var generateCardHtml = function(employeeList) {
    ...
    //function call to to to index.html file after cards are made
    writeFile(generatePagehtml(cardlayouts));
    //copy css for html file
    copyFile();
}
//takes cards and adds them to html template, then writes to file
